...
def print_protocol_banner() -> None:
    print("\n" + "=" * 70)
    print("  PAPER 3 MAIN BENCHMARK (MLX)")
    print("  Protocol : patch-based transfer proxy")
    print("  Part A   : same-L baselines on native lattices")
    print("  Part B   : train on 8x8, test on 16x16 top-left 8x8 patch")
